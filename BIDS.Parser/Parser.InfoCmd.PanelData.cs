...
public record BIDSCmd_Info_PanelData(
	char RawDataType,
	int RawDataNum,
...
) : BIDSCmd_Info(RawDataType, RawDataNum, DataInt, DataDouble), IBIDSCmd_Info_PanelData
{
	...
	public BIDSCmd_Info_PanelData(BIDSCmd_Info Base, IReadOnlyList<int> IndexList)
		: this(Base.RawDataType, Base.RawDataNum, IndexList, Base.DataInt, Base.DataDouble) { }

	public BIDSCmd_Info_PanelData(BIDSCmd_Info Base, int Index)
